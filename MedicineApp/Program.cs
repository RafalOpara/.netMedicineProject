...
builder.Services.AddTransient<IDoctorManger, DoctorManger>();
...
{
    options.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnection"), b => b.MigrationsAssembly("MedicineProject.Database"));
